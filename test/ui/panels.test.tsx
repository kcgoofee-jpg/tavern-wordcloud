...
describe('CommunityPanel', () => {
  it('explains why nothing is shown below the contributor minimum; the contribute checkbox calls back', async () => {
    ...
    render(<CommunityPanel loading={false} offline={false} contribute={false} setContribute={setContribute} onExpandCloud={() => {}}
      stats={{ contributors: 1, contributions: 1, messages: 5, chars: 100, views30d: 12, analyses30d: 3, minContributors: 3, words: [], trend: [], turns: [{ label: '<50', n: 1 }], zhRatio: 0.9, updated: 0, models: [], endpoints: [], kinds: [], genMs: null }} />);
