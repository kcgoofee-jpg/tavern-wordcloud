...
const EN: Record<string, string> = {
  ...
  '复制': 'Copy',
  '已认领的角色卡': 'Claimed character cards',
  '大家导入了什么': 'What people import',
  ...
  '（只拆开）': '(split only)',
  '正确词不能是错词本身': 'The correct words cannot include the wrong word itself',
  ...
  '武侠与修真': 'Martial arts & cultivation',
  '拟声词': 'Onomatopoeia',
  '度量单位': 'Units of measure',
  '族群与国籍': 'Peoples & nationalities',
  '头衔等级': 'Ranks',
  '法律': 'Law',
  '数量': 'Quantities',
  '行政区划': 'Administrative regions',
  '道路与交通设施': 'Roads & transit',
  // Kind groups (the collapsible sections of the kind buttons)
  '常用': 'Common',
  '人物与身份': 'People & identity',
