...
const EN: Record<string, string> = {
  ...
  '大家聊了多少层': 'How long chats run, in turns',
  '每份聊天的对话楼层数分布。{zh}': 'Turns per chat. {zh}',
  '中文词占 {p}%': '{p}% of words are Chinese',
  '还没有数据': 'No data yet',
  '今日 {n} 次 · 日均 {m} 次': 'Today {n} · {m}/day on average',
  '中位数落在 {b} 层': 'Median falls in {b}',
  '查看社区词云（{n} 个词）': 'View the community cloud ({n, plural, one {# word} other {# words}})',
