...
const KEEP = '.sheet, .quick-cluster, .community-quick, .cardinfo, .rail, .dock, .note-pop, .notice-pop, .notice-quick, .version-pop, .version-quick, .toast, .import-veil, .confirm-veil, .mode-quick, .lang-quick, .land-top';
